...
for(const day of weekdays){
    japaneseRestaurant.workingHours?.[day] &&
        console.log(`On ${day} restaurant opens at ${japaneseRestaurant.workingHours?.[day]?.open} / closes - ${japaneseRestaurant.workingHours?.[day]?.close}`);
}